export const workflowTemplates = [
  ...
  },
  {
    ...
    description: 'A lighter workflow for personal software projects, study plans, and experiments.',
    icon: 'sparkles',
    emoji: 'sparkles',
    color: 'emerald',
...
export function listWorkflowTemplates() {
  // Return fresh objects so callers cannot mutate the shared read-only catalog.
...
export function getWorkflowTemplate(templateId) {
  return listWorkflowTemplates().find((template) => template.id === templateId) || null;
}
