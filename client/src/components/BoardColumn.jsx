...
export default function BoardColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex max-h-[calc(100dvh-286px)] min-h-[360px] w-[min(88vw,320px)] shrink-0 flex-col rounded-lg border border-zinc-200 bg-zinc-100/70 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:w-[310px] md:max-h-[calc(100dvh-216px)] lg:max-h-[calc(100dvh-176px)]"
    >
